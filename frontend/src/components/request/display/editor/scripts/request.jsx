...
export default function PreRequestEditor(props) {
	const { value, setValue, options } = props;
	const editorRef = useRef();

	const postResponseSnippets = Request.preRequestSnippets();
	...
	return (
		<div className="request-code-editor pre-request-editor">
			<Editor
