export const PASSWORD_RESET_REQUEST_TEMPLATE = `
    ...
    <html lang="en">
        ...
        <body style="font-family: Inter, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="background: linear-gradient(to right, rgb(31, 80, 154), rgb(25, 70, 135)); padding: 20px; text-align: center;">
          ...
          <div style="background-color: #f9f9f9; padding: 20px; border-radius: 0 0 5px 5px; box-shadow: 0 2px 5px rgba(0,0,0,0.1);">
            ...
            <div style="text-align: center; margin: 30px 0;">
              <a href="{resetURL}" style="background-color: rgb(31, 80, 154); color: white; padding: 12px 20px; text-decoration: none; border-radius: 5px; font-weight: bold;">Reset Password</a>
            </div>
            <p>This link will expire in 1 hour for security reasons.</p>
            <p>Best regards,<br>APIFlow</p>
          </div>
